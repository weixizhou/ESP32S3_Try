...
const char *ssid = "245405";
const char *password = "24522888405";
// 在 ThingsCloud 控制台的设备详情页中，复制以下设备连接信息
// https://console.thingscloud.xyz
#define THINGSCLOUD_MQTT_HOST "gz-4-mqtt.iot-api.com"
#define THINGSCLOUD_DEVICE_ACCESS_TOKEN "kb6w6l2rp5o7pd5m"
#define THINGSCLOUD_PROJECT_KEY "O6ssR6xOB5"
//======================================================
